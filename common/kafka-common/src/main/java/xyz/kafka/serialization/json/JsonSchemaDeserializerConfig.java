...
/**
 * JsonSchemaDeserializerConfig
 *
 * @author chaoxin.lu
 * @version V 1.0
 * @since 2022-04-20
 */
public class JsonSchemaDeserializerConfig extends AbstractKafkaSchemaSerDerConf {

    public static final String FAIL_UNKNOWN_PROPERTIES = "json.fail.unknown.properties";
    public static final boolean FAIL_UNKNOWN_PROPERTIES_DEFAULT = false;
    ...
    public JsonSchemaDeserializerConfig(Map<?, ?> props) {
        super(DEFINE, props);
    }
