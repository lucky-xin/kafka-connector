...
/**
 * AllowSelfSignedSslEngineFactory
 *
 * @author chaoxin.lu
 * @version V 1.0
 * @since 2022-04-20
 */
public class AllowSelfSignedSslEngineFactory implements SslEngineFactory {
    private static final Logger log = LoggerFactory.getLogger(AllowSelfSignedSslEngineFactory.class);
